...
public sealed class FoundationStackTests
{
    ...
    public void FoundationStackProvidesAStreamAndPurposeBuiltRecoveryAndPdiQueues()
    {
        ...
        template.HasResourceProperties(
            "AWS::SQS::Queue",
            new Dictionary<string, object> { ["QueueName"] = "commerceos-test-0042-refund-inventory" });
        template.HasResourceProperties(
            "AWS::SQS::Queue",
            new Dictionary<string, object> { ["QueueName"] = "commerceos-test-0042-refund-payments" });
        template.HasResourceProperties(
            "AWS::SQS::Queue",
            new Dictionary<string, object> { ["QueueName"] = "commerceos-test-0042-notifications" });
        template.HasResourceProperties(
            "AWS::S3::Bucket",

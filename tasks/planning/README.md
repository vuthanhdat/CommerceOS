...
- Current approved MVP `PD-001`–`PD-053` decisions are resolved. Remaining implementation blockers are narrower domain/contract gaps explicitly recorded in the technical baseline, especially Storefront Tenant addressing, Accounting moving-weighted-average cost-pool scope, and refund-approval capability mapping.
